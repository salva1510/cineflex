(() => {
  ...
  const SERVERS = [
    {name:'Server 1 · VidFast', url:'https://vidfast.vc'},
    {name:'Server 2 · VidLink', url:'https://vidlink.pro'},
    {name:'Server 3 · Peachify', url:'https://peachify.pro'},
    {name:'Server 4 · 1Embed', url:'https://1embed.cc'},
    {name:'Server 5 · VidSrcMe', url:'https://vidsrcme.ru'},
    {name:'Server 6 · VidSrc', url:'https://vidsrc.to'},
    {name:'Server 7 · VSEmbed', url:'https://vsembed.ru'},
    {name:'Server 8 · 2Embed', url:'https://2embed.cc'},
    {name:'Server 9 · MoviePire', url:'https://video.moviepire.co'},
    {name:'Server 10 · VidSrc SBS', url:'https://vidsrc.sbs'},
    {name:'Server 11 · ZXCStream', url:'https://zxcstream.xyz'},
