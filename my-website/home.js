...
function handleSwipeDirection() {
    const threshold = 40; // Babaan natin para mas madaling mag-swipe/drag
...
// --- DESKTOP MOUSE EVENTS (FIXED FOR BROWSER DRAG) ---
function handleMouseDown(e) {
    isDragging = true;
    touchStartX = e.screenX;
    e.preventDefault(); // FIX: Pinipigilan ang default image selection/ghosting ng browser
}
