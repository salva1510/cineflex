...
function ensure(){
 ...
 <div class="cf-music-hero"><h2>Listen without leaving CineFlex</h2><p>Curated OPM, study, chill and sleep music from official or creator-hosted sources.</p><div class="cf-music-search"><i class="fa-solid fa-magnifying-glass"></i><input id="cfMusicSearch" type="search" placeholder="Search music, artist or mood" autocomplete="off"></div></div>
