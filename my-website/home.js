...
// DITO ANG AYOS NG HOMEPAGE ROW CARDS (PINUWERSANG MAG-OBJECT-FIT: COVER)
async function fetchRow(url, elementId, type) {
  try {
    ...
    data.results.forEach(item => {
      ...
      // Ginamitan ng styling para piliting mag-crop nang tama ang poster image sa loob ng 170x240 box
      card.innerHTML = `
...
// AYOS PARA SA SEARCH GRID (16:9 BACKDROP STYLE)
