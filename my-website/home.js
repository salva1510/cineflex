...
async function init() {
  try {
    // INAYOS: Ginamit ang watch_providers=8 para lumabas lahat ng Netflix movies sa PH region
    ...
    // Renders Netflix at DramaBox cards
...
async function viewAll(containerId) {
    ...
    if (containerId === "trending-today") {
        ...
        // INAYOS: Parehong filter ng init() para lumabas lahat sa View All
