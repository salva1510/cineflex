...
async function init() {
  try {
    // Pinalitan ang cocomelonData endpoint ng malawak na discover/tv para sa Kids & Family animation
    const [trd, marvel, anime, fil, kd, kp, kids, pinoyAction, dramabox, netflixMovies, cocomelonData] = await Promise.all([
      ...
      // Kumukuha ng madaming sikat na pambatang palabas (Animation + Kids genre) para mapuno ang row ng may valid poster_path
    ...
    // I-render ang pinalawak na Cocomelon & Kids scroller row
