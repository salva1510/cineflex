(() => {
  ...
  const SERVERS=[
    {id:'vidfast',name:'vidfast.vc',label:'Server 1',note:'Primary',movie:id=>`https://vidfast.vc/movie/${id}?autoPlay=true`,tv:(id,s,e)=>`https://vidfast.vc/tv/${id}/${s}/${e}?autoPlay=true`},
    ...
    {id:'vidsrcsbs',name:'vidsrc.sbs',label:'Server 10',note:'Backup 9',movie:id=>`https://vidsrc.sbs/embed/movie/${id}`,tv:(id,s,e)=>`https://vidsrc.sbs/embed/tv/${id}/${s}/${e}`},
  ...
  if(localStorage.getItem('cineflex_server_order_build')!=='302.3'){
    localStorage.setItem('cineflex_preferred_server','vidfast');
    localStorage.setItem('cineflex_server_order_build','302.3');
  }
