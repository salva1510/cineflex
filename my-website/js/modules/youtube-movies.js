(function(){
  ...
  window.cfOpenYouTubeMovies = function(){
    if(window.CineFlexPlugins && !window.CineFlexPlugins.isEnabled('youtubeMovies')){window.showToast?.('YT Movies is currently disabled.');return false;}
    init();
  ...
  window.CineFlexPlugins?.register('youtubeMovies',{open:window.cfOpenYouTubeMovies,close:window.cfCloseYouTubeMovies,refresh});
