...
// Para sa Homepage Row: Gumagamit ng POSTER_PATH (Patayo) para sa .card class
async function fetchRow(url, elementId, type) {
  try {
    ...
    data.results.forEach(item => {
      ...
      card.innerHTML = `
        <img src="${IMG_URL}${item.poster_path}" alt="poster" style="width:100%; height:100%; object-fit:cover;">
        <div class="card-info">
...
// Para sa Search Grid: Gumagamit ng BACKDROP_PATH (Pahiga) para sa 16:9 modern layout mo
    ...
    data.results.forEach(item => {
       ...
       div.innerHTML = `
          <div class="modern-thumb-wrapper">
             <img src="${IMG_URL}${targetImg}" class="modern-img" alt="img">
          </div>
...
// Para sa View All: Gumagamit din ng BACKDROP_PATH (Pahiga) para maging swak sa 16:9 box
