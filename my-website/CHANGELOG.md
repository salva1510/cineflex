## Build 310.1 — Server Order Update
- Promoted vidsrc.sbs from Server 10 to Server 1 / Primary.
- Moved vidfast.vc from Server 1 to Server 10.
- Updated player defaults, health checks, persistence migration, and cache.

## Build 309.0 — Comeback Experience
- Added daily check-in streak and return messaging.
- Added rotating Daily Pick with next-pick countdown.
- Added prominent Jump Back In card for the latest title.
- Added instant mood-based recommendation rows.
- Added responsive and TV-focus styling for all new retention features.
