...
// ==========================================
// --- KORREKTONG PWA INSTALLATION SYSTEM ---
// ==========================================
let deferredPrompt;
...
window.addEventListener('beforeinstallprompt', (e) => {
    ...
    // Hanapin ang button sa loob ng DOM para siguradong hindi null
...
document.addEventListener('click', async (e) => {
    if (e.target && (e.target.id === 'installBtn' || e.target.closest('#installBtn'))) {
...
window.addEventListener('appinstalled', (evt) => {
    console.log('Cineflex was successfully installed!');
    const installBtn = document.getElementById('installBtn');
    if (installBtn) installBtn.style.display = 'none';
});
