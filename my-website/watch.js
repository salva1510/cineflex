(() => {
  ...
  const SERVERS=[
    {id:'vidlink',name:'vidlink.pro',label:'Server 1',note:'Primary',movie:id=>`https://vidlink.pro/movie/${id}`,tv:(id,s,e)=>`https://vidlink.pro/tv/${id}/${s}/${e}`},
    ...
    {id:'zxc',name:'zxcstream.xyz',label:'Server 10',note:'Backup 9',movie:id=>`https://zxcstream.xyz/player/movie/${id}`,tv:(id,s,e)=>`https://zxcstream.xyz/player/tv/${id}/${s}/${e}`},
