...
function scope(){const layers=[...document.querySelectorAll('.modal,.search-overlay,.menu-drawer,[role="dialog"]')].reverse();return layers.find(e=>visible(e)&&(e.classList.contains('open')||e.classList.contains('active')||e.getAttribute('aria-hidden')==='false'))||document}
