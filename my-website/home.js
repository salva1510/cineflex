...
// --- BAGONG POP-UNDER ADS INJECTION ---
function triggerPopUnder() {
  const adScript = document.createElement('script');
  // Ginamit ang iyong bagong popunder link dito
...
function playSpecificEpisode(epNum, element) {
    ...
    // Ina-activate ang pop-under ad mula sa bashsecret pag-play ng episode
    triggerPopUnder();
}
...
function startPlayback() {
    ...
    // Ina-activate ang pop-under ad mula sa bashsecret pag-play ng movie
    triggerPopUnder();
}
