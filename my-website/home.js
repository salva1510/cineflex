...
// --- STREAMS SERVER CONFIGURATIONS ---
const SERVER_1_URL = "https://peachify.top";
const SERVER_2_URL = "https://1embed.cc";

let currentServer = 1; // Default ay Server 1 (Peachify)
...
async function showDetails(item) {
  currentItem = item;
  currentServer = 1; // I-reset sa Server 1 sa tuwing bubuksan ang bagong modal
  ...
  try {
    ...
    // Tawagin ang server rendering options UI
