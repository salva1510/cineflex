...
// MAIN PLAYER SERVER UPDATE: BIDSRC.PRO
function playSpecificEpisode(epNum, element) {
    ...
    // Updated to bidsrc.pro for TV
    iframe.src = `https://bidsrc.pro/embed/tv/${currentItem.id}/${currentTVState.season}/${epNum}`;
...
function startPlayback() {
    ...
    // Updated to bidsrc.pro for Movies
    iframe.src = `https://bidsrc.pro/embed/movie/${currentItem.id}`;
