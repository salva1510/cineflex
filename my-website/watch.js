(() => {
  ...
  const SERVERS=[
    {id:'zxc',name:'zxcstream.xyz',label:'Server 1',note:'Primary',movie:id=>`https://zxcstream.xyz/player/movie/${id}`,tv:(id,s,e)=>`https://zxcstream.xyz/player/tv/${id}/${s}/${e}`},
    {id:'peach',name:'peachify.pro',label:'Server 2',note:'Backup 1',movie:id=>`https://peachify.pro/embed/movie/${id}`,tv:(id,s,e)=>`https://peachify.pro/embed/tv/${id}/${s}/${e}`},
    ...
    {id:'vidsrcme',name:'vidsrcme.ru',label:'Server 4',note:'Backup 3',movie:id=>`https://vidsrcme.ru/embed/movie/${id}`,tv:(id,s,e)=>`https://vidsrcme.ru/embed/tv/${id}/${s}/${e}`},
    {id:'vidsrcto',name:'vidsrc.to',label:'Server 5',note:'Backup 4',movie:id=>`https://vidsrc.to/embed/movie/${id}`,tv:(id,s,e)=>`https://vidsrc.to/embed/tv/${id}/${s}/${e}`},
    {id:'vsembed',name:'vsembed.ru',label:'Server 6',note:'Backup 5',movie:id=>`https://vsembed.ru/embed/movie/${id}`,tv:(id,s,e)=>`https://vsembed.ru/embed/tv/${id}/${s}/${e}`},
    {id:'twoembed',name:'2embed.cc',label:'Server 7',note:'Backup 6',movie:id=>`https://2embed.cc/embed/${id}`,tv:(id,s,e)=>`https://2embed.cc/embedtv/${id}&s=${s}&e=${e}`},
    {id:'moviepire',name:'video.moviepire.co',label:'Server 8',note:'Backup 7',movie:id=>`https://video.moviepire.co/embed/movie/${id}`,tv:(id,s,e)=>`https://video.moviepire.co/embed/tv/${id}/${s}/${e}`},
    {id:'vidsrcsbs',name:'vidsrc.sbs',label:'Server 9',note:'Backup 8',movie:id=>`https://vidsrc.sbs/embed/movie/${id}`,tv:(id,s,e)=>`https://vidsrc.sbs/embed/tv/${id}/${s}/${e}`},
    {id:'vidlink',name:'vidlink.pro',label:'Server 10',note:'Backup 9',movie:id=>`https://vidlink.pro/movie/${id}`,tv:(id,s,e)=>`https://vidlink.pro/tv/${id}/${s}/${e}`},
    {id:'vidfast',name:'vidfast.vc',label:'Server 11',note:'Backup 10',movie:id=>`https://vidfast.vc/movie/${id}?autoPlay=true`,tv:(id,s,e)=>`https://vidfast.vc/tv/${id}/${s}/${e}?autoPlay=true`},
