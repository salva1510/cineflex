(() => {
  ...
  const SERVERS = [
    {name:'Server 1 · VidLink', url:'https://vidlink.pro'},
    {name:'Server 2 · Peachify', url:'https://peachify.pro'},
    {name:'Server 3 · 1Embed', url:'https://1embed.cc'},
    {name:'Server 4 · VidSrcMe', url:'https://vidsrcme.ru'},
    {name:'Server 5 · VidSrc', url:'https://vidsrc.to'},
    {name:'Server 6 · VSEmbed', url:'https://vsembed.ru'},
    {name:'Server 7 · 2Embed', url:'https://2embed.cc'},
    {name:'Server 8 · MoviePire', url:'https://video.moviepire.co'},
    {name:'Server 9 · VidSrc SBS', url:'https://vidsrc.sbs'},
    {name:'Server 10 · ZXCStream', url:'https://zxcstream.xyz'},
    {name:'Server 11 · VidFast', url:'https://vidfast.vc'},
    {name:'Server 12 · VidNest', url:'https://vidnest.fun'}
  ];
  const BUILD='300.4';
