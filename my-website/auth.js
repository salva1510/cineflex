// ======================================
// CINEFLEX AUTH v2.0 (CLEANED & OPTIMIZED)
// ======================================
...
function googleLogin() {
    ...
    .then(() => {
        ...
        closeLoginModal(); // Kusa nang magsasara kapag success
    })
...
// --- CENTRAL STATE MANAGEMENT (Pinagsamang Duplicates) ---

auth.onAuthStateChanged((user) => {
    // Kunin ang lahat ng kailangang DOM Elements
    ...
    if (user) {
        ...
        // I-execute ang nakapilang video/playback kung mayroon
        continuePendingPlayback();

        // 1. I-update ang Account Info Container (May profile image at pangalan)
        if (info) {
        ...
        // 2. I-update ang mga hiwalay na profile components kung mayroon sa page
        ...
        // 1. I-reset ang Account Info papuntang Guest
        if (info) {
            info.innerHTML = `<i class="fa-solid fa-user"></i> Guest`;
        }

        // 2. I-reset ang mga hiwalay na profile components
        ...
        // Opsyonal: Ipakita ang login modal kapag walang user na naka-login pagka-load ng page
        openLoginModal();
    }
});
...
function openLoginModal() {
    ...
    // Kung gawa na ang modal, i-display na lang para hindi paulit-ulit na mag-inject ng HTML
    if (modal) {
