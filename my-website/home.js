...
function displayCards(data, containerId) {
  ...
  // Magdagdag ng "View All" card sa dulo at ipasa ang mismong data ng section na ito
...
// Function para ipakita ang lahat ng items mula sa pinindot na section
function viewAll(categoryName, items) {
    const resultsDiv = document.getElementById("search-results"); // Ginagamit ang search grid layout
    const overlay = document.getElementById("search-overlay");
    
    if (!resultsDiv || !overlay) return;

    // Nilalagay ang lahat ng movie details ng partikular na section sa grid view
