...
async function init() {
  try {
    ...
    // Banner Button Event Listener Fix
    document.getElementById("banner-play-btn").addEventListener("click", () => {
...
async function showDetails(item) {
  ...
  // Load "More Like This" inside modal
  const recContainer = document.getElementById("modal-recommendations");
  recContainer.innerHTML = recs.results.slice(0, 6).map(r => `
