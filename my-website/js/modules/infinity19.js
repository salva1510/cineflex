...
(function(){
  ...
  function heroEnhance(){
    ...
    $$('.cf19-hero-meta',hero).forEach(el=>el.remove());
  ...
  function keyboardNav(){
    // Build 304.8: the homepage uses one exclusive D-pad controller.
    // Keeping this legacy listener caused ArrowDown to be consumed inconsistently.
    if (document.querySelector('script[src*="home-tv-trailer"]')) return;
  }
